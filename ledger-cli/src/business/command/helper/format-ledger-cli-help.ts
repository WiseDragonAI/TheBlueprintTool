...
export function formatLedgerCliHelp(): string {
  return [
    ...
    '  ledger-cli assets gc --root /path/to/workspace --write-plan .blueprinttool/assets-gc-plan.json',
    '  ledger-cli assets apply-gc-plan --root /path/to/workspace --plan .blueprinttool/assets-gc-plan.json',
  ].join('\n');
}
