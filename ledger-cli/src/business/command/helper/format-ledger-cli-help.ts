...
export function formatLedgerCliHelp(): string {
  return [
    ...
    '  prompt create --project <project-id> --name <name> --description <text> --markdown-file <file>',
    '      Create and Git-commit one server-owned pipeline prompt.',
    '  prompt update --project <project-id> --name <name> --markdown-file <file>',
    '      Replace and Git-commit one server-owned pipeline prompt after loading its current revision.',
    '',
