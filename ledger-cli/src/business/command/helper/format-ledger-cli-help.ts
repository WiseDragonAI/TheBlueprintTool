...
export function formatLedgerCliHelp(): string {
  return [
    ...
    '',
    '  program-create --plan-file <absolute-markdown-path>',
    ...
    '  program-amend --program-id <id> --plan-file <absolute-markdown-path>',
    '      Execute a durable approved Plan as dependency-admitted Software Iteration master cards.',
    '',
