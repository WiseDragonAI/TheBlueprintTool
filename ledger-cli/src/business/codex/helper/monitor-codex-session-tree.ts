...
const recognized = new Set(['program-create', 'program-context', 'iteration-start', 'phase-start', 'iteration-finish', 'program-amend', 'master-task-create', 'subtask-create', 'master-task-apply', 'master-task-progress', 'master-task-commit', 'master-task-gate', 'master-task-complete', 'work-package']);
const stepNames: Record<string, string> = { 'program-create': 'PROGRAM_INITIALIZE', 'program-context': 'PROGRAM_CONTEXT', 'iteration-start': 'ITERATION_START', 'phase-start': 'SPECIALIST_PHASE_START', 'iteration-finish': 'ITERATION_FINISH', 'program-amend': 'PROGRAM_AMEND', 'master-task-create': 'GRAPH_CREATE', 'subtask-create': 'GRAPH_CREATE', 'master-task-apply': 'GRAPH_UPDATE', 'master-task-progress': 'GRAPH_UPDATE', 'master-task-commit': 'GRAPH_COMMIT', 'master-task-gate': 'GRAPH_GATE', 'master-task-complete': 'GRAPH_COMPLETE', 'work-package': 'WORK_PACKAGE' };
