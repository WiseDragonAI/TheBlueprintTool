...
```bash
DECISION_OS_DRAG_TRACE_CARD_IDS=card-9026fced-519b-4a3b-b472-f8c655825f6c \
DECISION_OS_DRAG_TRACE_SCALES=0.35,0.5,0.75 \
DECISION_OS_DRAG_TRACE_VARIANTS=baseline \
DECISION_OS_DRAG_TRACE_HOVER_MODES=cold \
...
- Optional DOM read probes with `DECISION_OS_DRAG_TRACE_DOM_READ_PROBES=1`.
