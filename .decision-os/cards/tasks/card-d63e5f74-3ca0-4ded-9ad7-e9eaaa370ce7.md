...
1. G01-G11 source work is represented in `main`; G12 remains non-terminal; G13 production admission and delivery were not executed.
2. The first closeout claim at `5d309bb5` exceeded the recorded evidence, and `9a4034c8` integrated later source without producing a terminal release journal.
3. Replacement implementation groups must repair authority, atomic ownership, editor lifecycle, phone supervision, and verification before delivery.
4. Keep orchestration open.
