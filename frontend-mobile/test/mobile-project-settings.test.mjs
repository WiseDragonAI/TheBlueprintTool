...
import { projectSettingsValues, saveProjectSettingsRequest } from '../src/mobile-project-settings.js';
...
test('derives complete project settings fields', () => {
  ...
  assert.deepEqual(projectSettingsValues({ name: 'Project B' }), { name: 'Project B', description: '', color: '#38d9e8' });
});
