...
The complete tool contract is in [`documentation/working-documents/generalized-trace-evidence-tool-plan-and-specification.md`](documentation/working-documents/generalized-trace-evidence-tool-plan-and-specification.md). Installation and adapter adoption for another repository is in [`documentation/procedure/testing/install-trace-evidence-in-another-repository.md`](documentation/procedure/testing/install-trace-evidence-in-another-repository.md).
