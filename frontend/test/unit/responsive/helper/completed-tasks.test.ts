...
import { completedTaskLabels, filterCompletedTasks } from '../../../../src/app/responsive/completed-tasks.js';

const tasks = [
  { cardId: 'a', title: 'Ship desktop', projectId: 'editor', projectName: 'Editor', ledgerTitle: 'Specs', labels: ['release', 'desktop'] },
  { cardId: 'b', title: 'Mobile polish', projectId: 'editor', projectName: 'Editor', ledgerTitle: 'Tasks', labels: ['mobile'] },
  { cardId: 'c', title: 'API cleanup', projectId: 'server', projectName: 'Server', ledgerTitle: 'Tasks', labels: [] },
];
