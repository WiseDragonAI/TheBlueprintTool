/** WHAT: Preserves the source responsive Codex settings contract. WHY: Process capacity behavior must remain identical across viewport widths. */
import assert from 'node:assert/strict';
import test from 'node:test';
import { readFileSync } from 'node:fs';
import { resolve } from 'node:path';
import { loadCodexProcessSettings, saveCodexProcessSettings, stepCodexProcessLimit, validateCodexProcessLimit } from '../src/app/responsive/codex-settings.js';
