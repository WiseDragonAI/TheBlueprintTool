/** WHAT: Preserves responsive Codex-session deletion confirmation. WHY: Session identity must remain separate from note deletion in the shared thread surface. */
import assert from 'node:assert/strict';
import test from 'node:test';
import {
  createMobileThreadSessionDeletionHandler,
  resetMobileThreadConfirmationModal,
} from '../src/app/responsive/thread-session-deletion.js';
