...
export function createGroupFromRect(rect: { x: number; y: number; width: number; height: number }): void {
  ...
  group.dataset.spec = '1d444573 796827d0 4801e6c7 85c81d67 0421d906 dff19657 d9d57c2c 2476bfa1 d2fbfa28 612afeda 8a05ef46 5b918cd3 d4f90f42 abad6dcb';
  ...
  group.innerHTML = '<div class="zone-title">New group</div>';
