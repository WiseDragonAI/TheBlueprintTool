...
import { canvasPoint } from './canvas-point.js';
import { createZoneFromRect } from './create-zone-from-rect.js';
import { createGroupFromRect } from './create-group-from-rect.js';
