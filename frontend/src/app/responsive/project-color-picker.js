/**
 * WHAT: Converts and presents project colors through the responsive HSV picker.
 * WHY: Project identity editing must preserve the source mobile interaction contract.
 */
