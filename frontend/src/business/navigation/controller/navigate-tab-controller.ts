/**
 * WHAT: Implements the navigate-tab-controller controller from the front/back master ledger.
...
export async function navigateTabController(input: { action_payload?: AnyRecord; runtime_state?: AnyRecord; data_model?: AnyRecord } | AnyRecord = {}): Promise<AnyRecord> {
